...
const d = {
  ...
  createSpritesData: (t, s = !1) => {
    ...
    let h = 0;
    for (const o of t) {
      const f = o.position.x + o.offset.x * o.scale.x, g = o.position.y + o.offset.y * o.scale.y, m = o.scale.x, R = o.scale.y, B = o.tilesetRegion.x * (o.tileset.tileWidth + o.tileset.spacing) + o.tileset.margin, C = o.tilesetRegion.y * (o.tileset.tileHeight + o.tileset.spacing) + o.tileset.margin, M = o.tileset.tileWidth + ((o.tilesetRegion.width || 1) - 1) * (o.tileset.tileWidth + o.tileset.spacing), I = o.tileset.tileHeight + ((o.tilesetRegion.height || 1) - 1) * (o.tileset.tileHeight + o.tileset.spacing);
      for (let w = 0; w < r; ++w)
