  ...
  render(e, t) {
    ...
    for (const a of e.getLayersOrdered()) {
      if (!this.layersMap.has(a)) {
        const u = new Ke(this, a.isStatic);
      ...
      switch (h?.zIndex && (o = h.zIndex), a.renderOrder !== "manual" && this.createLayer({
        ...
        case "objectgroup": {
          if (t.onObject) {
            ...
            for (const d of u) {
              const m = d.x * s / e.tileWidth, f = d.y * r / e.tileHeight;
              t.onObject(d, m, f, o, this, a);
            }
          }
          break;
        }
...
class ot {
  constructor(e, t, i, s, r, o) {
    this.name = e, this.type = t, this.x = i, this.y = s, this.rotation = r, this.properties = o;
  }
  getProperty(e) {
    return this.properties?.find((t) => t.name === e)?.value;
  }
...
class nt extends ce {
  ...
  getObjects() {
    return this.objects.map((e) => new ot(e.name, e.type, e.x, e.y, w.degToRad(e.rotation || 0), e.properties));
  }
}
class fe {
  constructor(e, t, i, s) {
